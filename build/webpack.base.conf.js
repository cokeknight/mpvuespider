...
function getEntry (rootSrc) {
  var map = {}
  glob.sync(rootSrc + '/pages/**/index.js').concat(glob.sync(rootSrc + '/pages/**/**/index.js'))
    .concat(glob.sync(rootSrc + '/pages/**/**/**/index.js'))
    .forEach(file => {
...
const appEntry = { app: resolve(`./src/main.${process.env.PLATFORM}.js`) }
