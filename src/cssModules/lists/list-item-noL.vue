...
<template>
  ...
  >
    ...
    >
      ...
      <Icon v-if="frontIcon" :name="frontIcon" :size="iconSize" class="front-icon" />
      <div
        v-if="showLabel"
      ...
      <div
        ...
        :class="'list-menu-side no-flex ' + (sideClass || '')"
      >
        <img v-if="sideAvatar" :src="side" class="side-avatar" />{{ sideAvatar ? '' : side }}
      </div>
