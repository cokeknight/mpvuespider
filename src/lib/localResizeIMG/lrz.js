...
var BlobFormDataShim = require('./lib/Blob.FormData.shim'),
...
Lrz.prototype._createBase64ForOldIOS = function () {
  ...
  return new Promise(function (resolve) {
    require(['./lib/megapix-image'], function (MegaPixImage) {
...
Lrz.prototype._createBase64 = function () {
  ...
  return new Promise(function (resolve) {
    if (UA.oldAndroid || UA.mQQBrowser || !navigator.userAgent) {
      require(['./lib/jpeg_encoder_basic'], function (JPEGEncoder) {
...
Lrz.prototype._getResize = function () {
  ...
  while (ret.width >= 3264 || ret.height >= 2448) {
    console.info('超过这个值base64无法生成，在IOS上')
    ret.width *= 0.8
    ret.height *= 0.8
  }
